...
public sealed class WebSocketToolClient : IAsyncDisposable
{
    private readonly AppConfig _cfg;

    public WebSocketToolClient(AppConfig cfg)
    {
        _cfg = cfg;
    }

    public async Task<WebSocketTool> SendAsync(WebSocketToolRequest request, CancellationToken ct = default)
    {
        ...
        return new WebSocketTool(tcp, stream);
    }
